...
public class Cliente extends javax.swing.JFrame implements Runnable{
    ...
    private void jButonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButonActionPerformed
        try {
            ...
            datos.setNick("David");
            datos.setIp("192.168.0.7");
            datos.setMensaje(jTextField.getText());
            ...
            flujo_salida.writeUTF(jTextField.getText());
    ...
    public void run() {
        try {
            ...
            while(true){
                ...
                paqueteRecibido = (Datos) flujo_entrada.readObject();
                
                jTextArea1.append(" "+paqueteRecibido.getNick()+": "+paqueteRecibido.getMensaje()+"\n");
            }
        } catch (Exception e) {
